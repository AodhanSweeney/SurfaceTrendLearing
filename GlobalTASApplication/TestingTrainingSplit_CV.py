...
def tropical_mean_trend(trends, land_sea_mask, weights, latbounds):
    """ 
    Takes map of trends and finds average over various regions.
    """

    bounds = [[0,12], [12,20], [20,24], [24,28], [28,32], [32,36], [36,40], [40,44], [44,48], [48,52], [52,60], [60,72]]

    area_mean_trends = []
    for latbounds in bounds:
        ...
        area_mean_trends.append([TropicalAverageTrend, TropicalOceanTrend, TropicalLandTrend])
    return(area_mean_trends)
...
def training_testing_split(path_to_data):
    ...
    for x in range(len(ModelDataFiles)):
        ...
        OneCVTestingPredictorDataAverageTrendAreas = []
        for latbounds in bounds:
            # reshape predictors as vector
            ...
            OneCVTestingPredictorDataAverageTrendAreas.append(OneCVTestingPredictorDataAverageTrend)
        ...
        TestingTotalTrend.append(OneCVTestingPredictorDataAverageTrendAreas)
